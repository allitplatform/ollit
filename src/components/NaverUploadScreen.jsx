...
// 진단 정보 / 인코딩 자동 / 컬럼 매핑
// 2026-05-23 — parseNaverOrders + helper 측 src/lib/naverOrderParser.js 측 측 모듈 측 분리 (UsolNOrders.jsx 재사용)
...
// ===== 컬럼 매핑 + 주문 그룹화 — src/lib/naverOrderParser.js 측 측 (UsolNOrders.jsx 측 측 재사용) =====
