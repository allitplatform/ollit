...
export const INITIAL_TASKS = [
  ...
  // ============================================
  // V14 — 김동효(E001) 5월 시뮬 데이터 (단가/수수료 정책 정확 적용)
  // engineerNet = commissionCalc(principals.js) 결과 기준
  // 세척: 단가표 그대로 / 쿨가이 fake_split / 냉매: 총 × 50%
  // 세척+점검: 세척 단가 + 점검 +10,000
  // 점검/설치 단독은 Phase 1 disabled — 옛 70% 유지 (fallback)
  // ============================================
  // 5월 1일 (금) - 2건
  { id: "A260501-001", client: "올데이케어", customer: "박은서", phone: "010-1111-2222",
    ...
    estimateTotal: 80000, engineerNet: 40000, // 직영 벽걸이 40k
  },
  { id: "A260501-002", client: "쿨가이", customer: "이수진", phone: "010-2222-3333",
    ...
    status: "확정", startedAt: null, completedAt: null,
    estimateTotal: 120000, engineerNet: 60000, // 쿨가이 냉매 50% (총 120k)
  },
  // 5월 2일 (토) - 1건
  { id: "A260502-001", client: "올데이케어", customer: "정민호", phone: "010-3333-4444",
    ...
    status: "확정", startedAt: null, completedAt: null,
    estimateTotal: 200000, engineerNet: 120000, // 직영 스탠드 60k×2
  },
  // 5월 4일 (월) - 오늘 - 3건 (진행중 1 + 확정 2)
  { id: "A260504-001", client: "올데이케어", customer: "박지영(5/4)", phone: "010-4444-5555",
  ...
  { id: "A260504-002", client: "쿨가이", customer: "이상훈(5/4)", phone: "010-5555-6666",
    address: "서초구 반포동", fullAddress: "신반포로 270, 반포자이 103-1502",
    workType: "세척+점검", appliance: "스탠드", qty: 2,
    assignedEngineer: "김동효", assignedEngineerId: "E001",
    ...
    time: "11:30", endTime: "13:30", duration: "2h",
    status: "확정", startedAt: null, completedAt: null,
    estimateTotal: 200000, engineerNet: 130000, // 쿨가이 세척 스탠드 60k×2 + 점검 +10k
  },
  { id: "A260504-003", client: "올데이케어", customer: "김미경(5/4)", phone: "010-6666-7777",
    ...
    time: "14:00", endTime: "16:30", duration: "2.5h",
    status: "확정", startedAt: null, completedAt: null,
    estimateTotal: 120000, engineerNet: 60000, // 직영 냉매 50% (총 120k)
  },
  // 5월 6일 (수) - 2건
  { id: "A260506-001", client: "올데이케어", customer: "최동석", phone: "010-7777-8888",
    ...
    status: "확정", estimateTotal: 50000, engineerNet: 35000, // 점검 단독 — Phase 1 disabled (fallback 70%)
  },
  { id: "A260506-002", client: "쿨가이", customer: "윤서연", phone: "010-8888-9999",
    address: "서초구 양재동", workType: "설치", appliance: "벽걸이", qty: 1,
    assignedEngineer: "김동효", assignedEngineerId: "E001",
    scheduledDate: "2026-05-06", scheduledTime: "14:00",
    time: "14:00", endTime: "16:00", duration: "2h",
    status: "확정", estimateTotal: 150000, engineerNet: 105000, // 설치 단독 — Phase 1 disabled (fallback 70%)
  },
  // 5월 8일 (금) - 3건
  { id: "A260508-001", client: "올데이케어", customer: "강지훈", phone: "010-1010-2020",
    address: "강남구 삼성동", workType: "세척", appliance: "스탠드", qty: 1,
    assignedEngineer: "김동효", assignedEngineerId: "E001",
    scheduledDate: "2026-05-08", scheduledTime: "09:00",
    time: "09:00", endTime: "10:30", duration: "1.5h",
    status: "확정", estimateTotal: 100000, engineerNet: 60000, // 직영 스탠드 60k
  },
  { id: "A260508-002", client: "올데이케어", customer: "한미래", phone: "010-2020-3030",
    ...
    status: "확정", estimateTotal: 160000, engineerNet: 80000, // 직영 벽걸이 40k×2
  },
  { id: "A260508-003", client: "쿨가이", customer: "오지원", phone: "010-3030-4040",
    ...
    status: "확정", estimateTotal: 100000, engineerNet: 50000, // 쿨가이 냉매 50% (총 100k)
  },
  // 5월 9일 (토) - 1건 (약속대기)
  { id: "A260509-001", client: "올데이케어", customer: "서민재", phone: "010-4040-5050",
    address: "강남구 압구정동", workType: "점검", appliance: "에어컨", qty: 2,
    assignedEngineer: "김동효", assignedEngineerId: "E001",
    scheduledDate: "2026-05-09", scheduledTime: "11:00",
    time: "11:00", endTime: "12:30", duration: "1.5h",
    status: "약속대기", estimateTotal: 60000, engineerNet: 42000, // 점검 단독 — fallback 70%
  },
  // 5월 11일 (월) - 1건
  { id: "A260511-001", client: "쿨가이", customer: "임수아", phone: "010-5050-6060",
    address: "서초구 방배동", workType: "냉매충전", appliance: "시스템 멀티", qty: 1,
    assignedEngineer: "김동효", assignedEngineerId: "E001",
    scheduledDate: "2026-05-11", scheduledTime: "14:00",
    time: "14:00", endTime: "16:00", duration: "2h",
    status: "확정", estimateTotal: 130000, engineerNet: 65000, // 쿨가이 냉매 50% (총 130k)
  },
  // 5월 13일 (수) - 2건
  { id: "A260513-001", client: "올데이케어", customer: "권태수", phone: "010-6060-7070",
    address: "강남구 신사동", workType: "세척", appliance: "벽걸이", qty: 1,
    assignedEngineer: "김동효", assignedEngineerId: "E001",
    scheduledDate: "2026-05-13", scheduledTime: "10:00",
    time: "10:00", endTime: "11:30", duration: "1.5h",
    status: "확정", estimateTotal: 80000, engineerNet: 40000, // 직영 벽걸이 40k
  },
  { id: "A260513-002", client: "올데이케어", customer: "문혜진", phone: "010-7070-8080",
  ...
  // 5월 14일 (목) - 1건
  { id: "A260514-001", client: "쿨가이", customer: "배준호", phone: "010-8080-9090",
    address: "강남구 대치동", workType: "설치", appliance: "벽걸이", qty: 2,
    assignedEngineer: "김동효", assignedEngineerId: "E001",
    scheduledDate: "2026-05-14", scheduledTime: "11:00",
    time: "11:00", endTime: "13:00", duration: "2h",
    status: "확정", estimateTotal: 250000, engineerNet: 175000, // 설치 단독 — fallback 70%
  },
];
