...
// 2026-07-27 v2 — 주소 수정 공용 (사장님 spec: 연필 아이콘만 + 모든 카드에서).
async function _editTaskAddress(task) {
...
function AddrEditBtn({ task }) {
  return (
    <button
      onClick={(e) => { e.stopPropagation(); _editTaskAddress(task); }}
